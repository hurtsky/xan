...
return array(
	...
	'BaseURI'              => 'xan',                       // The base URI is the base web root on which your application lies.
	...
	'ThemeName'            => 'diabro',                // The theme name of the theme you would like to use.  Themes are in FLUX_ROOT/themes.
	...
	'GMPasswordMinUpper'   => 0,                        // Number of upper-case letters to require in passwords for GM accounts.
	'GMPasswordMinLower'   => 0,                        // Number of lower-case letters to require in passwords for GM accounts.
	'GMPasswordMinNumber'  => 0,                        // Number of numbers to require in passwords for GM accounts.
	'GMPasswordMinSymbol'  => 0,                        // Number of symbols to require in passwords for GM accounts.
